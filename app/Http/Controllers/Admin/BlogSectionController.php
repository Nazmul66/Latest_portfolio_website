...
class BlogSectionController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['rows']        = BlogSection::
                                leftJoin('users', 'users.id', 'blog_sections.user_id')
                                ->leftJoin('blog_categories', 'blog_categories.id', 'blog_sections.category_id')
                                ->select('blog_sections.*', 'blog_categories.name as blog_cat', 'users.name as admin_name')
                                ->orderBy('id', 'asc')->get();
