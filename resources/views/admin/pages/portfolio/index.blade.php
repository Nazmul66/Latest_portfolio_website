        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.portfolio.section.update', $section->id) }}" method="POST"
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h4 class="mb-sm-0 font-size-18">Portfolio List</h4>
                <a href="{{ route('admin.portfolio.create') }}" class="btn btn-primary waves-effect waves-light">Add New</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($rows as $key => $row)
                            <tr>
                                ...
                                <td>
                                    <span class="text-primary">{{ $row->project_name }}</span>
                                </td>
                                <td>
                                    <span class="badge bg-primary">{{ $row->project_category }}</span>
                                </td>
                                <td>
                                    <a class="text-success" style="text-decoration: underline !important;" href="{{ $row->url_link }}" target="__blank">Preview</a>
                                </td>
                                <td>
                                    @if ($row->status == 1)
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ route('admin.portfolio.edit', $row->id) }}"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.portfolio.delete', $row->id) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary text-white">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">View Portfolio List
                                            </h1>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="view_modal_content">
                                                ...
                                                <span>{{ $row->project_category }}</span>
                                            </div>

                                            <div class="view_modal_content">
                                                <label>Project Url : </label>
                                                <a href="{{ $row->url_link }}" style="text-decoration: underline !important;" class="text-success" target="__blank">Preview</a>
                                            </div>
