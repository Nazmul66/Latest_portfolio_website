...
@section('content')
    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.skills.index') }}" class="btn btn-primary waves-effect waves-light">Back</a>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.skills.update', $row->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="name" id="name" placeholder="Write here...." type="text"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="percentage" class="form-label">Skill Percentage <span
                                            class="text-danger">*</span></label>
                                    <input name="percentage" id="percentage" placeholder="Write here...." type="number" min="1" max="100"
                                        class="form-control" value="{{ old('percentage', $row->percentage) }}">
                                </div>
                            </div>
