                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="category_id" id="category_id">
                                        @foreach ($categories as $row)
                                            <option value="{{ $row->id }}" {{ $loop->first ? 'selected' : '' }}>
                                                {{ $row->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="meta_description" id="meta_description" placeholder="Write meta description here...." rows="5"></textarea>
                                </div>
                            </div>
                        </div>
