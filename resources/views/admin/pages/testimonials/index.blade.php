                        ...
                        @foreach ($rows as $key => $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ asset($row->client_image) }}" target="__blank">
                                        <img src="{{ asset($row->client_image) }}" alt="icon"
                                            style="width: 70px; height: 70px; object-fit: contain;">
                                    </a>
                                </td>
                                <td>
                                    <span class="text-primary">{{ $row->client_name }}</span>
                                </td>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="view_modal_content">
                                                <label>Rating : </label>
                                                <span class="text-warning">{{ $row->rating }} Star</span>
                                            </div>

                                            <div class="view_modal_content">
                                                <label>Description : </label>
                                                <span class="text-dark">{!! $row->client_desc !!}</span>
                                            </div>
